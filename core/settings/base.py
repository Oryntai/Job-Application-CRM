...
SPECTACULAR_SETTINGS = {
    "TITLE": "Job Application CRM API",
    "DESCRIPTION": "API for personal job application tracking.",
    "VERSION": "1.0.0",
...
CELERY_BEAT_SCHEDULE = {
    ...
    "daily-digest": {
        "task": "reminders.tasks.daily_digest",
        "schedule": 86400.0,
    },
}
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@jobcrm.local")
